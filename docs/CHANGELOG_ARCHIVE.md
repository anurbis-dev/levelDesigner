...
## Archived from CHANGELOG.md (drop new empty Level asset 404, 9e94bf76)
...
## Archived from CHANGELOG.md (Restore per-project Assets folder, v4.55.0, 744651a9)
...
## Archived from CHANGELOG.md (New Project resets Assets, v4.54.1, 71805576)
...
## Archived from CHANGELOG.md (LEDGE assets in editor library, 87115a6a)
...
## Archived from CHANGELOG.md (LEDGE platformer port, v4.50.0, c0461cbc)
...
## Archived from CHANGELOG.md (navMesh, v4.48.0)
...
## Archived from CHANGELOG.md (volume, v4.47.0)
...
## Archived from CHANGELOG.md (tileset + tilemap, v4.42.0)
...
## Archived from CHANGELOG.md (musicTrack + audioZone, v4.41.0)
...
## Archived from CHANGELOG.md (Canvases global delete/dup shortcuts, v4.38.1)

- **Fix: Canvases uses global editor commands (v4.38.1)**: Removed panel-local Delete/Duplicate buttons (form + widgets list + Delete canvas). Delete / X and Shift+D route to `CanvasHudPanel` when the Canvases dock is under the cursor (same registry `:hover` pattern as Outliner / Asset Preview). Widget delete preferred; else selected canvas. `deleteSelection()` / `duplicateSelection()` on the panel.

## Archived from CHANGELOG.md (Canvases editor UX, v4.38.0)
...
## Archived from CHANGELOG.md (HUD Canvas layout Preview, v4.37.0)
...
## Archived from CHANGELOG.md (HUD Canvas authoring UI, v4.36.0)
...
## Archived from CHANGELOG.md (saveSchema game-state persistence, v4.35.0)
