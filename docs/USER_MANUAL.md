# Руководство пользователя - 2D Level Editor v3.2.0
...
## Новые возможности v3.2.0

### Проверка позиции курсора после завершения анимации
- **Автоматическая проверка** - после завершения анимации проверяется позиция курсора
- **Защита от быстрых движений** - предотвращает проблемы при резком движении курсора
- **Надежное поведение** - меню закрывается если курсор оказался вне границ после анимации
- **Улучшенная стабильность** - корректная работа со всеми типами анимаций появления
- **Подробное логирование** - помогает в отладке проблем с позиционированием
...
- **Group** - объединение выделенных объектов в группу
- **Ungroup** - разбиение группы на отдельные объекты
...
- **Проверка после анимации** - после завершения анимации появления автоматически проверяется позиция курсора
- **Автоматическое закрытие при быстром движении** - если курсор оказался вне границ после анимации, меню закроется
