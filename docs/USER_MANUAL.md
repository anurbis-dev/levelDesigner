# Руководство пользователя - 2D Level Editor v2.9.0
...
### Упрощенное управление контекстными меню
- **Автоматическое закрытие** - меню закрывается при уводе курсора за границы
- **Мгновенная реакция** - нет необходимости кликать вне меню
- **Интуитивное поведение** - работает как в современных приложениях
...
- **Автоматическое закрытие** - меню закрывается автоматически при уводе курсора за границы меню
