# API Reference - 2D Level Editor v2.9.0
...
### Упрощенное закрытие контекстных меню (v2.9.0)
- **Автоматическое закрытие на mouseleave** - меню закрывается при уводе курсора за границы
- **Упрощенная логика** - удалена сложная логика клика вне меню
- **Лучший UX** - мгновенная реакция без необходимости кликать вне меню
