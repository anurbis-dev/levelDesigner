# API Reference - 2D Level Editor v3.2.0
...
## Новые функции v3.2.0

### Проверка позиции курсора после завершения анимации (v3.2.0)
- **Автоматическая проверка после анимации** - после завершения анимации проверяется позиция курсора
- **Закрытие меню при необходимости** - меню закрывается если курсор оказался вне границ после анимации
- **Защита от преждевременного закрытия** - предотвращает проблемы с быстрым движением курсора
- **Надежная работа с анимациями** - корректная обработка всех типов анимаций появления
- **Логирование для отладки** - подробные логи для анализа проблем с позиционированием
...
- **Проверка позиции после анимации** - автоматическая проверка курсора после завершения анимации
