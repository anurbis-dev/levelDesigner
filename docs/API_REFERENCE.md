# API Reference - 2D Level Editor v3.50.9
...
## Обновления v3.50.9 - Динамические панели и оптимизация сепараторов

### Исправления
- ✅ **Динамическая правая панель** - создается программно, как левая
- ✅ **Исправлен правый сепаратор** - корректная работа с тачпадом
- ✅ **Защита от дублирования слушателей** - флаги `_globalListenersAdded` и `_draggingSetup`
- ✅ **Оптимизированы логи** - убраны избыточные сообщения движения мыши

### Технические улучшения
- **Обновлен:** `PanelPositionManager.js` - исправлена логика вставки сепараторов
- **Обновлен:** `EventHandlers.js` - убраны избыточные логи инициализации
- **Обновлен:** `index.html` - правая панель создается динамически
- **Добавлена защита** от дублирования глобальных слушателей
