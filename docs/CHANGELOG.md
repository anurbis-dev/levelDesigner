...
- **Escape клавиша**: `Esc` теперь закрывает текущий уровень группы (в дополнение к клику вне рамки)
...
- `docs/USER_MANUAL.md` - Добавлена информация о поддержке вложенных групп
