...
### Refactored - Унификация логики resize для touch и mouse

#### 🔄 **Устранение дублирования кода:**
- **Единая система расчета** - touch и mouse используют одинаковые методы расчета размеров панелей
...
- **TouchSupportManager** - добавлены унифицированные методы расчета размеров
