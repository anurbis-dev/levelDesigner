# Архитектура Level Editor v3.50.9
...
- **Динамические панели (v3.50.9)** - правая панель создается программно с защитой от дублирования слушателей
...
- Методы: togglePanelPosition, ensurePanelExists, createPanelResizer, setupPanelResizer, moveTab
