# Архитектура Level Editor v3.50.8
...
**Компоненты:**
- **9 утилитарных классов** - централизованная бизнес-логика (добавлен PanelPositionManager)
...
- **Универсальная система позиций панелей (v3.50.8)** - централизованное управление позициями всех панелей

---

## 🛠️ Утилиты

### PanelPositionManager (v3.50.8)
...
- Централизованное сохранение позиций в UserPreferences
- Интеграция с StateManager для синхронизации состояния
- Методы: togglePanelPosition, updateFoldersLayout, updateRightPanelLayout
...
## 🎯 Универсальная система разделителей панелей v3.50.3
