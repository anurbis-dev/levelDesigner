...
**Известное ограничение:** нет editor authoring UI (dock panel) — эта фаза только engine runtime + data model (зеркалит Event Graph MVP → Event Graph UI разделение).
