...
export const COMPONENT_TYPES = [
    ...
    { id: 'sequenceCutscene', label: 'Sequence / Cutscene', description: 'Ordered timeline: move/camera/dialogue/vars; PlaySequence Event Graph action.', genres: 'all with cutscenes' }
];
