...
export function createListItemRow(prefix, config) {
    ...
    const parallaxHtml = parallax ? `
                <input type="number"
                       ...
                       class="${prefix}-parallax-input bg-gray-600 border border-gray-500 text-xs rounded px-1 py-1 w-12 h-8 text-center focus:outline-none focus:border-blue-500" style="color: var(--ui-text-color, #d1d5db);"
                       data-${prefix}-id="${id}"
