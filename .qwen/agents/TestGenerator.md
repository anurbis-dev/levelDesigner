...
- **DO save test files**: place new test modules near the existing ones (`src/event-system/` for event/input tests) or in a clearly named sibling file next to the code under test, using write_file or edit.
