...
## Фаза C — Object Properties окно (нужна раньше графа — негде иначе настраивать компоненты)  🔨 В РАБОТЕ (параллельная сессия, с 2026-07-17 — коммиты `ceaa61bd`/`7a2a1f4b`, `src/ui/asset-editor/`; не трогать эти файлы из других сессий, см. §7-collision-note ниже)
